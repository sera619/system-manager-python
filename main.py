...
class MainWindow(QMainWindow):
    ...
    def storage(self):
        ...
        for x in storage_device:
            ...
            #else:
                #self.create_table_widget(rowPosition, 4, "Function not available on " + plattforms[sys.platform], "storageTable")
                #self.create_table_widget(rowPosition, 5, "Function not available on " + plattforms[sys.platform], "storageTable")
    ...
    def sensors(self):
        ...
        if sys.platform == 'linux' or sys.platform == 'linux1' or sys.platform == 'linux2':           
            ...
            self.create_table_widget(rowPosition, 0, "Function not supported on " + plattforms[sys.platform], "sensorTable")
